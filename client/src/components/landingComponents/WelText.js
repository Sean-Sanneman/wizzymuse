...
const Weltext = () => {
    return (
        <>
                ...
                <h4>WizzyMuse is an online collaborative community. 
                  <br></br>
                ...
                <br></br>
                Our space allows you to put your collaboration together without worrying about technological issues. We all have our own ways we like to work, but that shouldn't stop us from putting the pieces together. Our community is about simplifying the process of collaborating remotely.</h4>
                </>
    )
};
