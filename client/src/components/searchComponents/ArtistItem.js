...
// Styles and Images
import { Container, Row, Col, Card, Button, setOpen, Collapse } from 'react-bootstrap';
            ...
            <Col>
                <Card.Body className="searchArtistTxt" style={{ padding: "1%" }}>
                    <Card.Title>Avatar 1</Card.Title>
                        ...
                        <Button className="collapseArtistItem" style={{ marginRight: "4%" }}
                        ...
                        <Collapse in={open}>
                            <div id="example-collapse-text">
                                ...
                                <h4>The more artists' information that we add, graphics, whatever, the collapsible "box"
                                    expands to allow it to fit. This may be useful, so that the initial artist "card" can
                                    be smaller, then the profile opens up when you toggle.</h4>
                            </div>
                        </Collapse>
